<div>
    <div>
        ...
        <button class="button" wire:click="newHistory">
            <i class="mr-1 icon ion-md-add text-primary"></i>
            @lang('crud.common.new')
        </button>
        @endcan @can('delete-any', App\Models\History::class)
        <button
    ...
    <div class="block w-full overflow-auto scrolling-touch mt-4">
        <table class="w-full max-w-full mb-4 bg-transparent">
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.hive_histories.inputs.action')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.hive_histories.inputs.date')
                    </th>
                    <th></th>
                </tr>
            </thead>
            ...
            <tfoot>
                <tr>
                    <td colspan="3">
                        <div class="mt-10 px-4">{{ $histories->render() }}</div>
                    </td>
                </tr>
            </tfoot>
        </table>
