<div>
    <div>
        ...
        <button class="button" wire:click="newNotification">
            <i class="mr-1 icon ion-md-add text-primary"></i>
            @lang('crud.common.new')
        </button>
        @endcan @can('delete-any', App\Models\Notification::class)
        <button
                ...
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.textarea
                            ...
                            label="Details"
                            wire:model="notification.details"
                        ></x-inputs.textarea>
                    </x-inputs.group>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.hive_notifications.inputs.event')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.hive_notifications.inputs.details')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.hive_notifications.inputs.date')
                    </th>
                    <th></th>
                </tr>
            </thead>
